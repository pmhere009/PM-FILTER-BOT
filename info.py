...
API_ID = int(environ.get('API_ID', '1879094'))
API_HASH = environ.get('API_HASH', '713300730e9fbd770d29fdfe5e9ef660')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '717601186').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001289169755').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://peeyooshm2023:yhl95r0SddN8f8SD@cluster0.fbosxhz.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "mcgroup")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001960740542'))
